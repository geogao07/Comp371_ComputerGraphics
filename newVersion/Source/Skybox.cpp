...
Skybox::Skybox(vec3 size, string positiveXImagePath, string negativeXImagePath, string positiveYImagePath, string negativeYImagePath, string positiveZImagePath, string negativeZImagePath)
{
	...
	this->skyboxPositiveXID = TextureLoader::LoadTexture("Textures/skyboxPositiveX.png");
	this->skyboxNegativeXID = TextureLoader::LoadTexture("Textures/skyboxNegativeX.png");
	this->skyboxPositiveYID = TextureLoader::LoadTexture("Textures/skyboxPositiveY.png");
	this->skyboxNegativeYID = TextureLoader::LoadTexture("Textures/skyboxNegativeY.png");
	this->skyboxPositiveZID = TextureLoader::LoadTexture("Textures/skyboxNegativeZ.png");
	this->skyboxNegativeZID = TextureLoader::LoadTexture("Textures/skyboxPositiveZ.png");
#else
	this->skyboxPositiveXID = TextureLoader::LoadTexture("../Assets/Textures/right.jpg");
	this->skyboxNegativeXID = TextureLoader::LoadTexture("../Assets/Textures/left.jpg");
	this->skyboxPositiveYID = TextureLoader::LoadTexture("../Assets/Textures/top.jpg");
	this->skyboxNegativeYID = TextureLoader::LoadTexture("../Assets/Textures/bottom.jpg");
	this->skyboxPositiveZID = TextureLoader::LoadTexture("../Assets/Textures/back.jpg");
	this->skyboxNegativeZID = TextureLoader::LoadTexture("../Assets/Textures/front.jpg");
#endif
