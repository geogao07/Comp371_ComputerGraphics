...
void World::Draw()
{
	...
	GLuint programID = Renderer::LoadShaders("../Assets/Shaders/SolidColor.vertexshader", "../Assets/Shaders/SolidColor.fragmentshader");
	...
	GLuint ViewLocationID = glGetUniformLocation(programID, "ViewLocation");
	glUniform3f(ViewLocationID, mCamera[mCurrentCamera]->GetViewMatrix()[3][0], mCamera[mCurrentCamera]->GetViewMatrix()[3][1], mCamera[mCurrentCamera]->GetViewMatrix()[3][2]);
